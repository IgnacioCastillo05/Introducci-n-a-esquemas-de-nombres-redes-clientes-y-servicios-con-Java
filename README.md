...
## 7. Lightweight REST Framework (HelloWebApp)
...
### 7.1 GET Static Method for REST Services
...
![GET endpoint example](img/rest1.png)

---

### 7.2 Query Value Extraction
...
![Query parameter extraction](img/rest2.png)

---

### 7.3 Static File Location
...
![Static file serving](img/rest3.png)
